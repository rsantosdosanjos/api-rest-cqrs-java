package nerd.chat.commandmodel;

import nerd.chat.coreapi.*;
...
public class ChatRoom {
  ...
  public void handle(PostMessageCommand command) {
    Assert.state(participants.contains(command.getParticipant()), "You cannot post messages unless you've joined the chat room.");
